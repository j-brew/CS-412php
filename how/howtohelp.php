        ...
        <div id="main">
            <div id="info">
               <div ></div>
                ...
                <p class="p2">Depending on your situation, you may want to make a gift now, 
                    provide a gift through your estate plan, or both.</p>
                <p class="p2">Current gifts to the Junior Jazz Foundation offer important 
                    ...
                    property.</p>
                <p class="p2">As a contributor to our dual mission of performance and education, 
                ...
                <div id="rightcol">
                    ...
                    <h3>George Shearing - Jazz Presenter - $5000 and above </h3>
                    <h3>Bucky Pizzarelli - Jazz Benefactor - $2000</h3>
                    <h3>Benny Goodman - Jazz Fan - $1000</h3>
                    <h3>Louis Armstrong - Jazz Patron - $500</h3>
                    <h3>Art Tatum - Jazz Friend - $250</h3>
                    <h3>George Gershwin - Jazz Member - $150 </h3>
                    <h3>Peggy Lee - Jazz Angel - $50</h3>
